...
import { InputBox, EnvironmentHelper, ApiHelper, ErrorMessages } from './Components'
...
export const ProfilePage = () => {
    ...
    const handleSave = () => {
        if (validate()) {
            ApiHelper.apiPost(EnvironmentHelper.AccessManagementApiUrl + "/users/updatePassword", { newPassword: password }).then(() => {
